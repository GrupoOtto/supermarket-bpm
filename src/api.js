...
module.exports = app => {
  ...
  app.post(
    ...
    handle(async (req, res) => {
      ...
      loggin.logOpen(list.products, caseId, list.total, jwt.extract(req), req.body.couponCode || null)
  ...
  app.post(
    ...
    handle(async (req, res) => {
      ...
      loggin.logEnd(req.body.caseId, req.body.saleInfo.user.email, jwt.extract(req), confirmation.total)
